namespace EAP_C2009L_Hoang_Thai_Son.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EAP_C2009L_Hoang_Thai_Son.Models.DataContext>
    {
        ...
        protected override void Seed(EAP_C2009L_Hoang_Thai_Son.Models.DataContext context)
        {
            base.Seed(context);
            //insert data here
